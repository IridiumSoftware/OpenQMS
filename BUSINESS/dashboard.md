...
| `:tested` | 97 | Architecture (7, OQ-012 + OQ-014 + OQ-115 + OQ-116 + OQ-117 + OQ-122 + OQ-124) · Substrate (3) · Workflow (9) · Module (61, OQ-040..OQ-059 + OQ-072..OQ-079 + OQ-081..OQ-096 + OQ-098 + OQ-101..OQ-114 + OQ-118) · Gap (17, OQ-060 + OQ-061 + OQ-062 + OQ-063 + OQ-064 + OQ-065 + OQ-066 + OQ-067 + OQ-068 + OQ-069 + OQ-080 + OQ-097 + OQ-099 + OQ-100 + OQ-119 + OQ-120 + OQ-121 + OQ-123) |
| `:benchmarked` | 0 | — |
| `:argued` | 5 | Invariant (1, OQ-003) · Substrate (2, OQ-022 + OQ-023) · Licensing (2, OQ-070 + OQ-071) |
| `:open` | 0 | — |
| **Total** | **108** | — |

Counts: 6 + 97 + 5 + 0 = 108 ✓. **Latest at v0.60.0**: Doc-control workflow hardening closes P5. OQ-124 NEW `:tested` (Architecture-tier). Three hardenings: PyYAML schema-validated parsing (replaces shell/grep; **hard-fail on version drift** — was warning); 8-state state-transition machine (document lifecycle + record lifecycle); audit-artifact per PR (JSON + Markdown w/ frontmatter delta + Signature-Meaning trailers + CI status; posted as PR comment + 90-day workflow artifact). 38 new pytest tests (count 175 → 213). Engine 0.59.0 → 0.60.0. Forward-work after v0.60.0: 11 closed · 3 open (P2 + P15 hard · P4 + P11 medium).
