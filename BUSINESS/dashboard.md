...
| `:tested` | 80 | Architecture (2, OQ-012 + OQ-014) · Substrate (3) · Workflow (9) · Module (53, OQ-040..OQ-059 + OQ-072..OQ-079 + OQ-081..OQ-096 + OQ-098 + OQ-101..OQ-107) · Gap (13, OQ-060 + OQ-061 + OQ-062 + OQ-063 + OQ-064 + OQ-065 + OQ-066 + OQ-067 + OQ-068 + OQ-069 + OQ-080 + OQ-097 + OQ-099 + OQ-100) |
| `:benchmarked` | 0 | — |
| `:argued` | 5 | Invariant (1, OQ-003) · Substrate (2, OQ-022 + OQ-023) · Licensing (2, OQ-070 + OQ-071) |
| `:open` | 0 | — |
| **Total** | **91** | — |

Counts: 6 + 80 + 5 + 0 = 91 ✓. **Latest at v0.39.0**: `:argued → :tested` push (2 entries). OQ-062 PHI/PII compartmentalization upgraded with 4 structural property tests asserting complaint intake template cannot capture PHI by design. OQ-067 repo-wide trace matrix shipped as new `openqms trace` CLI subcommand (walks all modules, emits forward + reverse maps + orphan detection + summary; JSON or Markdown). Pytest 108 → 116 (+8). CI extended with zero-orphan invariant check (`openqms trace --all` reports 75 modules / 614 clauses / 299 templates / 0 orphans at audit time). `:argued` count 7 → 5 (only honest-effort-by-nature entries remain: OQ-003 invariant + OQ-022/023 substrate + OQ-070/071 licensing).
