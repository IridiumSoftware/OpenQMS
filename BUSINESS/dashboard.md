...
| `:tested` | 78 | Architecture (2, OQ-012 + OQ-014) · Substrate (3) · Workflow (9) · Module (53, OQ-040..OQ-059 + OQ-072..OQ-079 + OQ-081..OQ-096 + OQ-098 + OQ-101..OQ-107) · Gap (11, OQ-060 + OQ-061 + OQ-063 + OQ-064 + OQ-065 + OQ-066 + OQ-068 + OQ-069 + OQ-080 + OQ-097 + OQ-099 + OQ-100) |
| `:benchmarked` | 0 | — |
| `:argued` | 7 | Invariant (1, OQ-003) · Substrate (2) · Licensing (2) · Gap (2, OQ-062 + OQ-067) |
| `:open` | 0 | — |
| **Total** | **91** | — |

Counts: 6 + 78 + 7 + 0 = 91 ✓. **Latest at v0.38.0**: chemicals class overlay batch shipped — chemicals-svhc + chemicals-authorisation + 4 tonnage bands (≥1/10/100/1000 t/y). 3 new templates (SVHC-COMMUNICATION-LETTER + REACH-AUTHORISATION-APPLICATION + SUBSTITUTION-PLAN). Class-overlay count 38 → 44 (first chemicals class overlays). **16-module composite validates** (new depth record): chemicals + SVHC + Authorisation + top tonnage + 4 adjacent + 8 cross-cutting. Cumulative v0.36-38: 11 chemicals-domain modules in 3 releases. Spec total 90 → 91.
