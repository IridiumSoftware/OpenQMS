...
| `:tested` | 77 | Architecture (2, OQ-012 + OQ-014) · Substrate (3) · Workflow (9) · Module (52, OQ-040..OQ-059 + OQ-072..OQ-079 + OQ-081..OQ-096 + OQ-098 + OQ-101..OQ-106) · Gap (11, OQ-060 + OQ-061 + OQ-063 + OQ-064 + OQ-065 + OQ-066 + OQ-068 + OQ-069 + OQ-080 + OQ-097 + OQ-099 + OQ-100) |
| `:benchmarked` | 0 | — |
| `:argued` | 7 | Invariant (1, OQ-003) · Substrate (2) · Licensing (2) · Gap (2, OQ-062 + OQ-067) |
| `:open` | 0 | — |
| **Total** | **90** | — |

Counts: 6 + 77 + 7 + 0 = 90 ✓. **Latest at v0.37.0**: chemicals-adjacent standalone batch shipped — osha-hcs (HazCom 2024) + transport-hazmat (DOT/IMDG/IATA/ADR/RID) + eu-biocides (BPR 528/2012) + tsca-pfas (40 CFR 705). 4 new templates. Registry +9 standards (8 PUBLIC; 2 commercial). Cross-cutting overlay count 19 → 23. **13-module composite validates** (new depth record). Discharges all 4 chemicals-companion forward-work items. Spec total 89 → 90.
