...
| `:tested` | 76 | Architecture (2, OQ-012 + OQ-014) · Substrate (3) · Workflow (9) · Module (51, OQ-040..OQ-059 + OQ-072..OQ-079 + OQ-081..OQ-096 + OQ-098 + OQ-101..OQ-105) · Gap (11, OQ-060 + OQ-061 + OQ-063 + OQ-064 + OQ-065 + OQ-066 + OQ-068 + OQ-069 + OQ-080 + OQ-097 + OQ-099 + OQ-100) |
| `:benchmarked` | 0 | — |
| `:argued` | 7 | Invariant (1, OQ-003) · Substrate (2) · Licensing (2) · Gap (2, OQ-062 + OQ-067) |
| `:open` | 0 | — |
| **Total** | **89** | — |

Counts: 6 + 76 + 7 + 0 = 89 ✓. **Latest at v0.36.0**: chemicals vertical (7th vertical) shipped — REACH + CLP + GHS + GLP + TSCA, 21 clauses, 4 chemicals-specific templates (SDS + REACH dossier + CLP notification + GLP study), all 5 standards PUBLIC license. New `example-specialty-chemical` bundle. Module-tier count 50 → 51. Spec total 88 → 89.
