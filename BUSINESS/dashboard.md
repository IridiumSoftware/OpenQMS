...
| `:tested` | 81 | Architecture (2, OQ-012 + OQ-014) · Substrate (3) · Workflow (9) · Module (54, OQ-040..OQ-059 + OQ-072..OQ-079 + OQ-081..OQ-096 + OQ-098 + OQ-101..OQ-108) · Gap (13, OQ-060 + OQ-061 + OQ-062 + OQ-063 + OQ-064 + OQ-065 + OQ-066 + OQ-067 + OQ-068 + OQ-069 + OQ-080 + OQ-097 + OQ-099 + OQ-100) |
| `:benchmarked` | 0 | — |
| `:argued` | 5 | Invariant (1, OQ-003) · Substrate (2, OQ-022 + OQ-023) · Licensing (2, OQ-070 + OQ-071) |
| `:open` | 0 | — |
| **Total** | **92** | — |

Counts: 6 + 81 + 5 + 0 = 92 ✓. **Latest at v0.41.0**: Privacy cross-cutting overlay shipped — GDPR + CCPA/CPRA; 21 clauses; 5 new templates (PRIVACY-POLICY + DPA + DPIA + ROPA + PERSONAL-DATA-BREACH-NOTIFICATION). 24th cross-cutting overlay; **last major management-system gap closed**. Registry +2 PUBLIC standards. **17-module ultimate composite validates** (new depth record). Zero-orphan invariant holds repo-wide (76 modules / 639 clauses / 305 templates / 0 orphans). Spec total 91 → 92.
